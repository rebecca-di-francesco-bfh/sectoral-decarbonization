...
def process_period(period_code, period_label):
    ...
    # File paths
    optim_file = f"results/optimal_portfolios/optimal_portfolios_all_te_{period_code}_capped.pkl"
    pickle_file = f"results/flexibility/sector_bands_{period_code}_capped.pkl"
    excel_file = f"results/flexibility/l2_bandwidth_turnover_{period_code}_capped.xlsx"
...
def main():
    ...
    # Save panel
    flexibility_panel.to_excel("results/flexibility/sector_flexibility_raw_capped.xlsx", index=False)
    ...
    scored_panel.to_excel("results/flexibility/sector_flexibility_normalised_capped.xlsx", index=False)
    ...
    flexibility_score_output = "results/flexibility/flexibility_scores_by_period_capped.xlsx"
