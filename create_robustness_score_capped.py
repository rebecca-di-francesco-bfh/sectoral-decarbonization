...
def process_period(period, benchmark_sectors_daily_returns, sector_annualized_volatility_by_quarter):
    ...
    optim_file = f"results/optimal_portfolios_capped/optimal_portfolios_all_te_{period}.pkl"
    ...
    te_df.to_excel(f"results/robustness/te_results_{period}_next_3m_capped.xlsx", index=False)
...
def main():
    ...
    output_file = "results/robustness/robustness_scores_by_period_capped.xlsx"
