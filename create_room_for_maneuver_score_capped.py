...
for period in periods:
    fname = f"results/optimal_portfolios/optimal_portfolios_all_te_{period}_capped.pkl"
...
output_file_scores = "results/room_for_maneuver/room_for_maneuver_scores_by_period_capped.xlsx"
