...
# --- Room for Maneuver ---
room_df = pd.read_excel("results/room_for_maneuver/room_for_maneuver_scores_by_period_capped.xlsx")
# Expected columns: ["Sector", "Period", "Room_for_Maneuver_Score_Adjusted"]

# --- Flexibility ---
flex_df = pd.read_excel("results/flexibility/flexibility_scores_by_period_capped.xlsx")
...
# --- Robustness ---
robust_df = pd.read_excel("results/robustness/robustness_scores_by_period_capped.xlsx")
...
plot_all_dimension_evolution(room_df, flex_df, sens_df, robust_df, savepath="results/DRI/dri_dimension_evolution_capped.pdf"
)
...
# 6. SAVE RESULTS
# =============================================================================
final_df.to_excel("results/DRI/decarbonization_readiness_index_capped.xlsx", index=False)
print("✅ Saved DRI results to results/DRI/decarbonization_readiness_index_capped.xlsx")
